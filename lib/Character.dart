...
List characters = [
  Character(
      name: 'Kevin',
      imagePath: 'images/Kevin_minions.png',
  ...
  Character(
      name: 'Agnes',
      imagePath: 'images/Agnes_gru.png',
  ...
  Character(
      name: 'Homer',
      imagePath: 'images/homer.png',
      description: "Homer Simpson, whose irresponsibility gets the best of him when he pollutes the lake in Springfield after the town has cleaned it up, causing the Environmental Protection Agency to imprison the town under a giant dome.the leader of the trio in search of a new master. He truly cares about the well-being of the Minion tribe (which is dependent on them having a proper master).",
      colors: [Colors.yellow.shade200, Colors.yellowAccent.shade400]
  ),
  Character(
      name: 'Tom And Jerry',
      imagePath: 'images/tom_jerry .png',
      description: "Homer is one of the Minions and the protagonist in the film Minions. Kevin is a tall, two-eyed minion with sprout cut hair and is usually seen wearing his golf apparel. Kevin loves to make fun of and tease people or Minions, shown when he made fun of Jerry and teases him for being a coward. He loves playing golf and cricket. In the film Minions he is the leader of the trio in search of a new master. He truly cares about the well-being of the Minion tribe (which is dependent on them having a proper master).",
      colors: [Colors.blue.shade200, Colors.blueAccent.shade400]
  ),
  Character(
      name: 'Family Guy',
      imagePath: 'images/family_guy.png',
      description: "Homer is one of the Minions and the protagonist in the film Minions. Kevin is a tall, two-eyed minion with sprout cut hair and is usually seen wearing his golf apparel. Kevin loves to make fun of and tease people or Minions, shown when he made fun of Jerry and teases him for being a coward. He loves playing golf and cricket. In the film Minions he is the leader of the trio in search of a new master. He truly cares about the well-being of the Minion tribe (which is dependent on them having a proper master).",
